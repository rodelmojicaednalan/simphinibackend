                        ...
                        <tr>
                          <td style="border-spacing: 0px; border-collapse: collapse; line-height: 24px; font-size: 16px; margin: 0;" align="left">
                            ...
                            >
                              <thead>
                                <tr>
                                  <th class="col-md-12" align="left" valign="top" style="line-height: 24px; font-size: 16px; margin: 0;">
                                    <table
                                      class="card"
                                      border="0"
                                      cellpadding="0"
                                        ...
                                        <tr>
                                          <td style="border-spacing: 0px; border-collapse: collapse; line-height: 24px; font-size: 16px; width: 100%; margin: 0;" align="left">
                                            <div style="text-align: center">
                                              <img src="{{ url('images/email-header.jpg') }}" class="card-img-top email-img" style="height: auto; line-height: 100%; outline: none; text-decoration: none; width: 50%; margin: 0 auto; border: 0 none;" />
                                              <table
                                                class="card-body"
                                                border="0"
                                                cellpadding="0"
                                                ...
                                                <tbody>
                                                  <tr>
                                                    <td style="border-spacing: 0px; border-collapse: collapse; line-height: 24px; font-size: 16px; width: 100%; margin: 0; padding: 20px;" align="left">
                                                      <div>
                                                        <h5 class="card-title" style="margin-top: 0; margin-bottom: 0; font-weight: 500; vertical-align: baseline; font-size: 20px; line-height: 24px;" align="left">
                                                          Welcome to Simphini
                                                        </h5>
                                                        <br />
                                                        <p class="card-text" style="line-height: 24px; font-size: 16px; width: 100%; margin: 0;" align="left">
                                                          Thank you for signing up. We are glad you are here and we hope you enjoy what Simphini have in store for you.
                                                        </p>
                                                        <br />
                                                        <table
